...
let creatureName = "The Dark One";


// 2. Declare a variable named 'creatureDescription' and describe its magical properties as a string.

let creatureDescription = "The Dark One is able to slip in to the darkness, when it comes; being able to disappear";
...
let zooSummary = "Bob can visit " + creatureName + "(" + creatureDescription + ")," + "which is friendly" + "(" + isFriendly + ")"
